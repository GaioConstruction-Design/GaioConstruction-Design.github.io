...
(function () {
  ...
  const I18N = {
    el: {
      ...
      'hero.lead':        'Εξειδικευμένες γεωτεχνικές, στατικές και υδραυλικές μελέτες για έργα υποδομής — με 24+ χρόνια εμπειρίας στην αλληλεπίδραση εδάφους–κατασκευής.',
      'hero.meta.title':  'Πάτρα, Ελλάδα',
      'hero.meta.sub':    'Μελέτες · Συμβουλευτική · Επιτόπου υποστήριξη',
      ...
      'about.num':        'Σχετικά',
      'about.h2':         'Πολιτικός Μηχανικός με εξειδίκευση στη γεωτεχνική.',
      ...
      'about.lead':       'Συνεργάζομαι με μηχανικούς, γεωλόγους και κατασκευαστικές εταιρείες για να μετατρέπω σύνθετα γεωτεχνικά προβλήματα σε υλοποιήσιμες, ασφαλείς και οικονομικές μελέτες.',
      'about.body':       'Η εξειδίκευσή μου επικεντρώνεται στην αλληλεπίδραση εδάφους–κατασκευής — έναν τομέα όπου η ανάλυση απαιτεί συνδυασμό in-situ ερευνών, εργαστηριακών δοκιμών και αξιόπιστων αριθμητικών προσομοιώσεων. Από το 2002 έχω συμβάλει σε έργα κάθε κλίμακας, από ιδιωτικές κατοικίες έως δημόσια έργα υποδομής.',
      'about.body2':      'Παρέχω και επιτόπου υποστήριξη κατά την κατασκευή, όταν οι συνθήκες πεδίου διαφέρουν από αυτές της μελέτης ή απαιτείται γρήγορη λήψη απόφασης σε δύσκολες εδαφικές συνθήκες.',
      'about.bio.0.year': '2002',
      'about.bio.0.text': '<b>Διπλωματούχος Πολιτικός Μηχανικός</b>, Πανεπιστήμιο Πατρών.',
      'about.bio.1.year': '2004',
      'about.bio.1.text': '<b>Μεταπτυχιακό Δίπλωμα Ειδίκευσης</b> σε Έργα Υποδομής Πολιτικού Μηχανικού.',
      'about.bio.2.year': '2004–',
      'about.bio.2.text': '<b>Εξειδίκευση σε Γεωτεχνικά Έργα</b>, αλληλεπίδραση εδάφους–κατασκευής.',
      ...
      'services.intro':   'Από τη φάση της προμελέτης μέχρι την επιτόπου επίβλεψη — υπηρεσίες που εκπονούνται με κατάλληλα λογισμικά και βασίζονται σε επιτόπου έρευνα.',

      'service.1.title':  'Συμβουλευτική',
      'service.1.desc':   'Υποστήριξη σε έργα υποδομής όπου το έδαφος απαιτεί εξειδικευμένη γνώση. Ανάλυση κινδύνου, εκτίμηση εναλλακτικών λύσεων και τεκμηριωμένες προτάσεις προς μελετητές, εργολάβους και κυρίους του έργου.',
      'service.2.title':  'Επιτόπου γεωτεχνική έρευνα',
      'service.2.desc':   'Διάνοιξη ερευνητικών και δειγματοληπτικών γεωτρήσεων και εκτέλεση επιτόπου δοκιμών αντοχής, διαπερατότητας και χαρακτηρισμού του εδάφους.',
      'service.3.title':  'Γεωφυσικές δοκιμές',
      'service.3.desc':   'Εφαρμογή μεθόδων επιφανειακών κυμάτων MASW και ReMi για τον προσδιορισμό της κατανομής Vs-depth profile και της σεισμικής συμπεριφοράς του εδάφους.',
      'service.4.title':  'Υποβρύχια αυτοψία',
      'service.4.desc':   'Υποβρύχια επισκόπηση λιμενικών έργων, επιβεβαίωση διαστάσεων κατασκευών, φωτογραφική και βιντεοσκοπική τεκμηρίωση, τεχνική έκθεση αυτοψίας. Υποστήριξη βυθομετρικής αποτύπωσης με sonar.',
      'service.5.title':  'Μελέτες',
      'service.5.desc':   'Εξειδικευμένες μελέτες αντιστήριξης, θεμελίωσης, ευστάθειας πρανών και υδραυλικών δικτύων, με χρήση κατάλληλων λογισμικών — Plaxis, RocFall, EpaNet κ.ά.',
      ...
      'tools.num':        'Λογισμικά & μέθοδοι',
      'tools.h2':         'Εργαλεία ανάλυσης και πεδίου.',
      'tools.intro':      'Επαγγελματικά λογισμικά πεπερασμένων στοιχείων και επιτόπου τεχνικές που υποστηρίζουν τις μελέτες.',
      'tool.plaxis.desc': 'Πεπερασμένα στοιχεία για γεωτεχνικές αναλύσεις — αντιστηρίξεις, θεμελιώσεις, παραμορφώσεις.',
      'tool.rocfall.desc':'Προσομοίωση καταπτώσεων βράχων και ανάλυση κινδύνου σε φυσικά πρανή.',
      'tool.epanet.desc': 'Υδραυλική ανάλυση δικτύων ύδρευσης και υπολογισμός παροχών/πιέσεων.',
      'tool.masw.desc':   'Μέθοδος επιφανειακών κυμάτων για τον προσδιορισμό του Vs-depth profile.',

      'projects.num':     'Έργο',
      'projects.h2':      'Πρόσφατο μελετημένο έργο.',
      'projects.intro':   'Επιλεγμένο παράδειγμα της προσέγγισης — από την αξιολόγηση πεδίου στη μελέτη και στην επιτόπου υλοποίηση.',
      'project.1.title':  'Αντιστήριξη παλαιού πετρόχτιστου τοίχου',
      'project.1.lead':   'Γεωτεχνική και στατική μελέτη αντιστήριξης παλαιού τοίχου με σημάδια μεγάλης παραμόρφωσης, κατά τη διάρκεια έργων οδοποιίας έμπροσθεν.',
      ...
      'contact.location.value':'Πάτρα, Ελλάδα',
      ...
      'foot.about':       'Διπλωματούχος Πολιτικός Μηχανικός · Μελέτες & υπηρεσίες αλληλεπίδρασης εδάφους–κατασκευής στην Ελλάδα.',
      'foot.col1':        'Πλοήγηση',
      'foot.col2':        'Υπηρεσίες',
    ...
    en: {
      ...
      'foot.col3':        'Contact',
      'foot.copy':        '© 2026 GaioConstruction Design',
      'foot.built':       'Static site · Patras, Greece',
