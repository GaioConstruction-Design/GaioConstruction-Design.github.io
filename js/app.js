...
(function () {
  ...
  const I18N = {
    el: {
      ...
      'about.num':        'Σχετικά',
      'about.h2':         'Πολιτικός Μηχανικός με εξειδίκευση στη γεωτεχνική μηχανική',
      ...
      'about.body':       'Η εξειδίκευσή μου επικεντρώνεται στην αλληλεπίδραση εδάφους–κατασκευής, έναν τομέα όπου η ανάλυση απαιτεί συνδυασμό επί-τόπου ερευνών, εργαστηριακών δοκιμών και αξιόπιστων αριθμητικών προσομοιώσεων. Από το 2002 έχω συμβάλει σε έργα κάθε κλίμακας, από ιδιωτικές κατοικίες έως δημόσια έργα υποδομής.',
      'about.body2':      'Παρέχω επιτόπου υποστήριξη κατά την υλοποίηση του έργου, όταν οι συνθήκες πεδίου διαφέρουν από αυτές της μελέτης ή απαιτείται γρήγορη λήψη απόφασης σε δύσκολες εδαφικές συνθήκες.',
      ...
      'service.5.desc':   'Εξειδικευμένες Γεωτεχνικές Μελέτες θεμελίωσης κατασκευών, αντιστήριξης εδάφους, ευστάθειας πρανών και αποκατάστασης κατολισθήσεων, βραχοπτώσεων, στατικών μελέτων διαστασιολόγησης και όπλισης έργων αντιστήριξης, καθώς και μελέτες υδραυλικών δικτύων, με χρήση κατάλληλων λογισμικών — Plaxis, RocFall, EpaNet κ.ά.',
      ...
      'tool.rocfall.desc':'Προσομοίωση καταπτώσεων βράχων και ανάλυση / διαστασιολόγηση έργων προστασίας από βραχοπτώσεις. Εκτίμηση τροχίας καταπτώσεων σε πρανή και οδούς και υπολογισμός μέγιστης ενέργειας πρόσκρουσης. Διαστασιολόγηση φρακτών ανάσχεσης καταπτώσεων και υπολογισμός θεμελίωσης / αγκυρώσεων.',
      'tool.epanet.desc': 'Υδραυλική ανάλυση δικτύων ύδρευσης, υπολογισμός παροχών/πιέσεων. Διαστασιολόγηση σωληνώσεων και απαιτούμενων εξαρτημάτων δικτύου για την ορθή λειτουργίας του.',
      ...
      'project1.body.p1': 'Παλαιός πετρόχτιστος τοίχος αντιστήριξης παρουσίαζε σημάδια παραμόρφωσης. Κατά τη διάρκεια εργασιών οδοποιίας έμπροσθεν του τοίχου υπήρχε αυξημένος κίνδυνος κατάρρευσης, σε ένα ιδιαίτερα ευαίσθητο περιβάλλον ανάντη.',
