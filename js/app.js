...
(function () {
  ...
  const I18N = {
    el: {
      ...
      'about.body2':      'Παρέχω επιτόπου υποστήριξη κατά την κατασκευή, όταν οι συνθήκες πεδίου διαφέρουν από αυτές της μελέτης ή απαιτείται γρήγορη λήψη απόφασης σε δύσκολες εδαφικές συνθήκες.',
