...
(function () {
  ...
  const I18N = {
    el: {
      ...
      'about.bio.2.text': '<b>Εξειδίκευση σε Γεωτεχνικά Έργα, μελέτες & υπηρεσίες για ιδιώτες, μηχανικούς και κατασκευαστικές εταιρείες. </b>, αλληλεπίδραση εδάφους–κατασκευής.',
