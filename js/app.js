...
(function () {
  ...
  const I18N = {
    el: {
      ...
      'about.body2':      'Παρέχεται επιτόπου υποστήριξη και κατά την υλοποίηση του έργου, όταν οι συνθήκες πεδίου διαφέρουν από αυτές της μελέτης ή απαιτείται γρήγορη λήψη απόφασης σε δύσκολες εδαφικές συνθήκες.',
      ...
      'about.bio.2.text': '<b>Εξειδίκευση σε Γεωτεχνικά Έργα & Υδραυλικά Έργα: </b>Mελέτες & υπηρεσίες για ιδιώτες, μηχανικούς και κατασκευαστικές εταιρείες.',
      ...
      'project1.body.p1': 'Παλαιός πετρόχτιστος τοίχος αντιστήριξης παρουσίαζε σημάδια παραμόρφωσης.',
